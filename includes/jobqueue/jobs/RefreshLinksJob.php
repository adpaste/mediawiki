...
class RefreshLinksJob extends Job {
	...
	protected function runForTitle( Title $title ) {
		...
		$options = $this->getDataUpdateOptions( $ticket );
	...
	/**
	 * @param int|null $ticket a transaction ticket from LBFactory::getEmptyTransactionTicket()
	 * @return array
	 */
	private function getDataUpdateOptions( ?int $ticket ) {
		$options = [
