...
global $wgAPICacheHelpTimeout, $wgAPIFormatModules, $wgAPIListModules, $wgAPIMaxDBRows,
	   $wgAPIMaxLagThreshold, $wgAPIMaxResultSize, $wgAPIMaxUncachedDiffs, $wgAPIMetaModules,
	   $wgAPIModules, $wgAPIPropModules, $wgAPIRequestLog, $wgAPIUselessQueryPages,
	   $wgAccountCreationThrottle, $wgActionFilteredLogs, $wgActionPaths, $wgActions,
	   $wgActiveUserDays, $wgActorTableSchemaMigrationStage, $wgAdaptiveMessageCache, $wgAddGroups,
	   $wgAdditionalMailParams, $wgAdvancedSearchHighlighting, $wgAdvertisedFeedTypes,
	   $wgAjaxEditStash, $wgAjaxExportList, $wgAjaxLicensePreview, $wgAjaxUploadDestCheck,
	   ...
	   $wgAllowJavaUploads, $wgAllowSchemaUpdates,
	   $wgAllowSecuritySensitiveOperationIfCannotReauthenticate, $wgAllowSiteCSSOnRestrictedPages,
	   $wgAllowSlowParserFunctions, $wgAllowSpecialInclusion, $wgAllowTitlesInSVG, $wgAllowUserCss,
	   $wgAllowUserCssPrefs, $wgAllowUserJs, $wgAmericanDates, $wgAntivirus, $wgAntivirusRequired,
	   $wgAntivirusSetup, $wgApiFrameOptions, $wgAppleTouchIcon, $wgApplyIpBlocksToXff,
	   $wgArticleCountMethod, $wgArticlePath, $wgArticleRobotPolicies,
	   $wgAssumeProxiesUseDefaultProtocolPorts, $wgAsyncHTTPTimeout, $wgAttemptFailureEpoch,
	   $wgAuthManagerAutoConfig, $wgAuthManagerConfig, $wgAuthenticationTokenVersion,
	   $wgAutoConfirmAge, $wgAutoConfirmCount, $wgAutoblockExpiry, $wgAutoloadAttemptLowercase,
	   $wgAutoloadClasses, $wgAutopromote, $wgAutopromoteOnce, $wgAutopromoteOnceLogInRC,
	   $wgAvailableRights, $wgBlockAllowsUTEdit, $wgBlockCIDRLimit, $wgBlockDisablesLogin,
	   $wgBotPasswordsCluster, $wgBotPasswordsDatabase, $wgBreakFrames, $wgCSPFalsePositiveUrls,
	   $wgCSPHeader, $wgCSPReportOnlyHeader, $wgCacheDirectory, $wgCacheEpoch, $wgCachePages,
	   $wgCachePrefix, $wgCacheSharedUploads, $wgCacheVaryCookies, $wgCanonicalServer,
	   $wgCapitalLinkOverrides, $wgCapitalLinks, $wgCascadingRestrictionLevels,
	   $wgCategoryCollation, $wgCategoryMagicGallery, $wgCategoryPagingLimit, $wgCdnMaxageLagged,
	   $wgCdnMaxageSubstitute, $wgCdnReboundPurgeDelay, $wgCentralIdLookupProvider,
	   $wgCentralIdLookupProviders, $wgChangeCredentialsBlacklist, $wgCheckFileExtensions,
	   $wgCleanSignatures, $wgCommandLineDarkBg, $wgCompressRevisions, $wgConf, $wgConfigRegistry,
	   $wgContentHandlerTextFallback, $wgContentHandlerUseDB, $wgContentHandlers,
	   $wgContentNamespaces, $wgCookieDomain, $wgCookieExpiration, $wgCookieHttpOnly,
	   $wgCookiePath, $wgCookiePrefix, $wgCookieSecure, $wgCookieSetOnAutoblock,
	   $wgCookieSetOnIpBlock, $wgCopyUploadProxy, $wgCopyUploadTimeout, $wgCopyUploadsDomains,
	   $wgCopyUploadsFromSpecialUpload, $wgCountCategorizedImagesAsUsed,
	   $wgCrossSiteAJAXdomainExceptions, $wgCrossSiteAJAXdomains, $wgCustomConvertCommand,
	   $wgDBDefaultGroup, $wgDBOracleDRCP, $wgDBTableOptions, $wgDBWindowsAuthentication,
	   $wgDBadminpassword, $wgDBadminuser, $wgDBcompress, $wgDBerrorLog, $wgDBerrorLogTZ,
	   $wgDBmwschema, $wgDBname, $wgDBpassword, $wgDBport, $wgDBprefix, $wgDBserver, $wgDBservers,
	   $wgDBssl, $wgDBtype, $wgDBuser, $wgDataCenterUpdateStickTTL, $wgDebugAPI, $wgDebugComments,
	   $wgDebugDumpSql, $wgDebugLogFile, $wgDebugLogGroups, $wgDebugLogPrefix,
	   $wgDebugPrintHttpHeaders, $wgDebugRawPage, $wgDebugRedirects, $wgDebugTimestamps,
	   $wgDebugToolbar, $wgDefaultExternalStore, $wgDefaultLanguageVariant, $wgDefaultRobotPolicy,
	   $wgDefaultSkin, $wgDefaultUserOptions, $wgDeleteRevisionsBatchSize, $wgDeleteRevisionsLimit,
	   $wgDeletedDirectory, $wgDeprecationReleaseLimit, $wgDevelopmentWarnings, $wgDiff, $wgDiff3,
	   $wgDirectoryMode, $wgDisableAnonTalk, $wgDisableCookieCheck, $wgDisableHardRedirects,
	   $wgDisableInternalSearch, $wgDisableLangConversion, $wgDisableOutputCompression,
	   $wgDisableQueryPageUpdate, $wgDisableQueryPages, $wgDisableSearchUpdate,
	   $wgDisableTextSearch, $wgDisableTitleConversion, $wgDisableUploadScriptChecks,
	   $wgDisabledVariants, $wgDjvuDump, $wgDjvuOutputExtension, $wgDjvuPostProcessor,
	   $wgDjvuRenderer, $wgDjvuToXML, $wgDjvuTxt, $wgDnsBlacklistUrls, $wgDummyLanguageCodes,
	   $wgEditPageFrameOptions, $wgEditSubmitButtonLabelPublish, $wgEdititis, $wgElementTiming,
	   $wgEmailAuthentication, $wgEmailConfirmToEdit, $wgEmergencyContact, $wgEnableAsyncUploads,
	   $wgEnableAutoRotation, $wgEnableBotPasswords, $wgEnableCanonicalServerLink,
	   $wgEnableDnsBlacklist, $wgEnableEmail, $wgEnableImageWhitelist, $wgEnableJavaScriptTest,
	   $wgEnableMagicLinks, $wgEnableOpenSearchSuggest, $wgEnableParserLimitReporting,
	   $wgEnablePartialBlocks, $wgEnableProfileInfo, $wgEnableScaryTranscluding,
	   $wgEnableSearchContributorsByIP, $wgEnableSidebarCache, $wgEnableUploads,
	   $wgEnableUserEmail, $wgEnableUserEmailBlacklist, $wgEnableWANCacheReaper,
	   $wgEnotifFromEditor, $wgEnotifImpersonal, $wgEnotifMaxRecips, $wgEnotifMinorEdits,
	   $wgEnotifRevealEditorAddress, $wgEnotifUseRealName, $wgEnotifUserTalk, $wgEnotifWatchlist,
	   $wgEventRelayerConfig, $wgExemptFromUserRobotsControl, $wgExiftool, $wgExiv2Command,
	   $wgExpensiveParserFunctionLimit, $wgExperiencedUserEdits, $wgExperiencedUserMemberSince,
	   $wgExportAllowAll, $wgExportAllowHistory, $wgExportAllowListContributors,
	   $wgExportFromNamespaces, $wgExportMaxHistory, $wgExportMaxLinkDepth, $wgExportPagelistLimit,
	   $wgExtendedLoginCookieExpiration, $wgExtensionAssetsPath, $wgExtensionCredits,
	   $wgExtensionDirectory, $wgExtensionEntryPointListFiles, $wgExtensionFunctions,
	   $wgExtensionInfoMTime, $wgExtensionMessagesFiles, $wgExternalDiffEngine,
	   $wgExternalInterwikiFragmentMode, $wgExternalLinkTarget, $wgExternalServers,
	   $wgExternalStores, $wgExtraGenderNamespaces, $wgExtraInterlanguageLinkPrefixes,
	   $wgExtraLanguageCodes, $wgExtraLanguageNames, $wgExtraNamespaces,
	   $wgExtraSignatureNamespaces, $wgFallbackSkin, $wgFavicon, $wgFeaturePolicyReportOnly,
	   $wgFeed, $wgFeedCacheTimeout, $wgFeedClasses, $wgFeedDiffCutoff, $wgFeedLimit,
	   $wgFetchCommonsDescriptions, $wgFileBackends, $wgFileBlacklist, $wgFileCacheDepth,
	   $wgFileCacheDirectory, $wgFileExtensions, $wgFilterLogTypes, $wgFixArabicUnicode,
	   $wgFixDoubleRedirects, $wgFixMalayalamUnicode, $wgFooterIcons, $wgForceUIMsgAsContentMsg,
	   $wgForcedRawSMaxage, $wgForeignFileRepos, $wgForeignUploadTargets, $wgFragmentMode,
	   $wgGalleryOptions, $wgGenerateThumbnailOnParse, $wgGitBin, $wgGitInfoCacheDirectory,
	   $wgGitRepositoryViewers, $wgGrammarForms, $wgGrantPermissionGroups, $wgGrantPermissions,
	   $wgGroupPermissions, $wgGroupsAddToSelf, $wgGroupsRemoveFromSelf, $wgHKDFAlgorithm,
	   $wgHKDFSecret, $wgHTCPMulticastTTL, $wgHTCPRouting, $wgHTMLFormAllowTableFormat,
	   $wgHTTPConnectTimeout, $wgHTTPImportTimeout, $wgHTTPProxy, $wgHTTPTimeout,
	   $wgHashedSharedUploadDirectory, $wgHashedUploadDirectory, $wgHiddenPrefs,
	   $wgHideIdentifiableRedirects, $wgHideInterlanguageLinks, $wgHideUserContribLimit, $wgHooks,
	   $wgHtml5, $wgHtml5Version, $wgHttpsPort, $wgIgnoreImageErrors, $wgIllegalFileChars,
	   $wgImageLimits, $wgImageMagickConvertCommand, $wgImageMagickTempDir, $wgImgAuthDetails,
	   $wgImgAuthUrlPathMap, $wgImplicitGroups, $wgImportSources, $wgImportTargetNamespace,
	   $wgIncludeLegacyJavaScript, $wgInternalServer, $wgInterwikiCache, $wgInterwikiExpiry,
	   $wgInterwikiFallbackSite, $wgInterwikiMagic, $wgInterwikiPrefixDisplayTypes,
	   $wgInterwikiScopes, $wgInvalidPasswordReset, $wgInvalidRedirectTargets,
	   $wgInvalidUsernameCharacters, $wgInvalidateCacheOnLocalSettingsChange,
	   $wgJobBackoffThrottling, $wgJobClasses, $wgJobQueueIncludeInMaxLagFactor, $wgJobRunRate,
	   $wgJobSerialCommitThreshold, $wgJobTypeConf, $wgJobTypesExcludedFromDefaultQueue,
	   $wgJpegPixelFormat, $wgJpegQuality, $wgJpegTran, $wgJsMimeType, $wgLBFactoryConf,
	   $wgLangObjCacheSize, $wgLanguageCode, $wgLanguageConverterCacheType, $wgLearnerEdits,
	   $wgLearnerMemberSince, $wgLegacyEncoding, $wgLegacyJavaScriptGlobals,
	   $wgLegacySchemaConversion, $wgLegalTitleChars, $wgLinkHolderBatchSize, $wgLoadScript,
	   $wgLocalDatabases, $wgLocalFileRepo, $wgLocalInterwiki, $wgLocalInterwikis,
	   $wgLocalStylePath, $wgLocalTZoffset, $wgLocalVirtualHosts, $wgLocalisationCacheConf,
	   $wgLocaltimezone, $wgLockManagers, $wgLogActions, $wgLogActionsHandlers,
	   $wgLogExceptionBacktrace, $wgLogHeaders, $wgLogNames, $wgLogRestrictions, $wgLogTypes,
	   $wgLoginLanguageSelector, $wgLogo, $wgLogoHD, $wgMWLoggerDefaultSpi, $wgMainCacheType,
	   $wgMainStash, $wgMainWANCache, $wgMangleFlashPolicy, $wgMaxAnimatedGifArea,
	   $wgMaxArticleSize, $wgMaxCredits, $wgMaxGeneratedPPNodeCount, $wgMaxImageArea,
	   $wgMaxInterlacingAreas, $wgMaxJobDBWriteDuration, $wgMaxMsgCacheEntrySize, $wgMaxNameChars,
	   $wgMaxPPExpandDepth, $wgMaxPPNodeCount, $wgMaxRedirectLinksRetrieved, $wgMaxRedirects,
	   $wgMaxShellFileSize, $wgMaxShellMemory, $wgMaxShellTime, $wgMaxShellWallClockTime,
	   $wgMaxSigChars, $wgMaxTemplateDepth, $wgMaxTocLevel, $wgMaxUploadSize,
	   $wgMaxUserDBWriteDuration, $wgMaximalPasswordLength, $wgMaximumMovedPages, $wgMediaHandlers,
	   $wgMediaInTargetLanguage, $wgMemCachedDebug, $wgMemCachedPersistent, $wgMemCachedServers,
	   $wgMemCachedTimeout, $wgMemoryLimit, $wgMessageCacheType, $wgMessagesDirs, $wgMetaNamespace,
	   $wgMetaNamespaceTalk, $wgMimeDetectorCommand, $wgMimeInfoFile, $wgMimeType,
	   $wgMimeTypeBlacklist, $wgMimeTypeFile, $wgMinUploadChunkSize, $wgMinimalPasswordLength,
	   $wgMiserMode, $wgMsgCacheExpiry, $wgMultiContentRevisionSchemaMigrationStage,
	   $wgNamespaceAliases, $wgNamespaceContentModels, $wgNamespaceProtection,
	   $wgNamespaceRobotPolicies, $wgNamespacesToBeSearchedDefault, $wgNamespacesWithSubpages,
	   $wgNewPasswordExpiry, $wgNewUserLog, $wgNoFollowDomainExceptions, $wgNoFollowLinks,
	   $wgNoFollowNsExceptions, $wgNoReplyAddress, $wgNonincludableNamespaces,
	   $wgObjectCacheSessionExpiry, $wgObjectCaches, $wgOpenSearchDefaultLimit,
	   $wgOpenSearchDescriptionLength, $wgOpenSearchTemplate, $wgOpenSearchTemplates,
	   $wgOriginTrials, $wgOverrideHostname, $wgOverrideSiteFeed, $wgOverrideUcfirstCharacters,
	   $wgPHPSessionHandling, $wgPageCreationLog, $wgPageInfoTransclusionLimit,
	   $wgPageLanguageUseDB, $wgPagePropLinkInvalidations, $wgPagePropsHaveSortkey,
	   $wgParserCacheExpireTime, $wgParserCacheType, $wgParserConf, $wgParserOutputHooks,
	   $wgParserTestFiles, $wgParserTestMediaHandlers, $wgPasswordAttemptThrottle,
	   $wgPasswordConfig, $wgPasswordDefault, $wgPasswordExpirationDays, $wgPasswordExpireGrace,
	   $wgPasswordPolicy, $wgPasswordReminderResendTime, $wgPasswordResetRoutes, $wgPasswordSalt,
	   $wgPasswordSender, $wgPhpCli, $wgPingback, $wgPoolCounterConf, $wgPopularPasswordFile,
	   $wgPreprocessorCacheThreshold, $wgPreviewOnOpenNamespaces, $wgPriorityHints,
	   $wgPriorityHintsRatio, $wgProfileLimit, $wgProfileOnly, $wgProfiler, $wgPropagateErrors,
	   $wgProxyList, $wgProxyWhitelist, $wgPutIPinRC, $wgQueryCacheLimit, $wgQueryPageDefaultLimit,
	   $wgRCChangedSizeThreshold, $wgRCEngines, $wgRCFeeds, $wgRCFilterByAge, $wgRCLinkDays,
	   $wgRCLinkLimits, $wgRCMaxAge, $wgRCShowChangedSize, $wgRCShowWatchingUsers,
	   $wgRCWatchCategoryMembership, $wgRangeContributionsCIDRLimit, $wgRateLimits,
	   $wgRateLimitsExcludedIPs, $wgRawHtml, $wgRawHtmlMessages, $wgReadOnly, $wgReadOnlyFile,
	   $wgReadOnlyWatchedItemStore, $wgReauthenticateTime, $wgRecentChangesFlags,
	   $wgRedirectOnLogin, $wgRedirectSources, $wgReferrerPolicy, $wgRegisterInternalExternals,
	   $wgRemoveCredentialsBlacklist, $wgRemoveGroups, $wgRenderHashAppend, $wgReportToEndpoints,
	   $wgReportToExpiry, $wgRepositoryBaseUrl, $wgReservedUsernames, $wgResourceBasePath,
	   $wgResourceLoaderDebug, $wgResourceLoaderEnableJSProfiler, $wgResourceLoaderMaxQueryLength,
	   $wgResourceLoaderMaxage, $wgResourceLoaderSources, $wgResourceLoaderStorageEnabled,
	   $wgResourceLoaderStorageVersion, $wgResourceLoaderValidateJS, $wgResourceModuleSkinStyles,
	   $wgResourceModules, $wgResponsiveImages, $wgRestrictDisplayTitle, $wgRestrictionLevels,
	   $wgRestrictionTypes, $wgRevisionCacheExpiry, $wgRevokePermissions, $wgRightsIcon,
	   $wgRightsPage, $wgRightsText, $wgRightsUrl, $wgRunJobsAsync, $wgSMTP, $wgSQLMode,
	   $wgSQLiteDataDir, $wgSVGConverter, $wgSVGConverterPath, $wgSVGConverters, $wgSVGMaxSize,
	   $wgSVGMetadataCutoff, $wgScript, $wgScriptPath, $wgSearchForwardUrl,
	   $wgSearchHighlightBoundaries, $wgSearchRunSuggestedQuery, $wgSearchSuggestCacheExpiry,
	   $wgSearchType, $wgSearchTypeAlternatives, $wgSecretKey, $wgSecureLogin,
	   $wgSemiprotectedRestrictionLevels, $wgSend404Code, $wgServer, $wgServerName,
	   $wgServiceWiringFiles, $wgSessionCacheType, $wgSessionInsecureSecrets, $wgSessionName,
	   $wgSessionPbkdf2Iterations, $wgSessionProviders, $wgSessionSecret, $wgSharedDB,
	   $wgSharedPrefix, $wgSharedSchema, $wgSharedTables, $wgSharedThumbnailScriptPath,
	   $wgSharedUploadDBname, $wgSharedUploadDBprefix, $wgSharedUploadDirectory,
	   $wgSharedUploadPath, $wgSharpenParameter, $wgSharpenReductionThreshold, $wgShellCgroup,
	   $wgShellLocale, $wgShellRestrictionMethod, $wgShortPagesNamespaceBlacklist,
	   $wgShowArchiveThumbnails, $wgShowCreditsIfMax, $wgShowDBErrorBacktrace, $wgShowDebug,
	   $wgShowEXIF, $wgShowExceptionDetails, $wgShowHostnames, $wgShowRollbackEditCount,
	   $wgShowSQLErrors, $wgShowUpdatedMarker, $wgSidebarCacheExpiry, $wgSiteNotice,
	   $wgSiteStatsAsyncFactor, $wgSiteTypes, $wgSitemapNamespaces, $wgSitemapNamespacesPriorities,
	   $wgSitename, $wgSkipSkin, $wgSkipSkins, $wgSlaveLagCritical, $wgSlaveLagWarning,
	   $wgSoftBlockRanges, $wgSoftwareTags, $wgSpamRegex, $wgSpecialPageCacheUpdates,
	   $wgSpecialPages, $wgSpecialVersionShowHooks, $wgSquidMaxage, $wgSquidPurgeUseHostHeader,
	   $wgSquidServers, $wgSquidServersNoPurge, $wgStatsdMetricPrefix, $wgStatsdSamplingRates,
	   $wgStatsdServer, $wgStrictFileExtensions, $wgStructuredChangeFiltersLiveUpdatePollingRate,
	   $wgStyleDirectory, $wgStylePath, $wgStyleSheetPath, $wgSummarySpamRegex, $wgSysopEmailBans,
	   $wgTextModelsToParse, $wgThumbLimits, $wgThumbUpright, $wgThumbnailBuckets,
	   $wgThumbnailEpoch, $wgThumbnailMinimumBucketDistance, $wgThumbnailScriptPath, $wgTidyConfig,
	   $wgTiffThumbnailType, $wgTmpDirectory, $wgTrackingCategories, $wgTransactionalTimeLimit,
	   $wgTranscludeCacheExpiry, $wgTranslateNumerals, $wgTrivialMimeDetection,
	   $wgTrustedMediaFormats, $wgTrxProfilerLimits, $wgUniversalEditButton,
	   $wgUnwatchedPageSecret, $wgUnwatchedPageThreshold, $wgUpdateCompatibleMetadata,
	   $wgUpdateRowsPerJob, $wgUpdateRowsPerQuery, $wgUpgradeKey, $wgUploadBaseUrl,
	   $wgUploadDialog, $wgUploadDirectory, $wgUploadMaintenance, $wgUploadMissingFileUrl,
	   $wgUploadNavigationUrl, $wgUploadPath, $wgUploadSizeWarning, $wgUploadStashMaxAge,
	   $wgUploadStashScalerBaseUrl, $wgUploadThumbnailRenderHttpCustomDomain,
	   $wgUploadThumbnailRenderHttpCustomHost, $wgUploadThumbnailRenderMap,
	   $wgUploadThumbnailRenderMethod, $wgUrlProtocols, $wgUseAjax, $wgUseAutomaticEditSummaries,
	   $wgUseCategoryBrowser, $wgUseCombinedLoginLink, $wgUseCopyrightUpload,
	   $wgUseDatabaseMessages, $wgUseESI, $wgUseFileCache, $wgUseFilePatrol, $wgUseGzip,
	   $wgUseImageMagick, $wgUseImageResize, $wgUseInstantCommons, $wgUseKeyHeader,
	   $wgUseLocalMessageCache, $wgUseMediaWikiUIEverywhere, $wgUseNPPatrol, $wgUsePathInfo,
	   $wgUsePigLatinVariant, $wgUsePrivateIPs, $wgUseRCPatrol, $wgUseSharedUploads, $wgUseSiteCss,
	   $wgUseSiteJs, $wgUseSquid, $wgUseTagFilter, $wgUseTeX, $wgUseTinyRGBForJPGThumbnails,
	   $wgUseTwoButtonsSearchForm, $wgUserEmailConfirmationTokenExpiry, $wgUserEmailUseReplyTo,
	   $wgUserrightsInterwikiDelimiter, $wgUsersNotifiedOnAllChanges, $wgValidSkinNames,
	   $wgVariantArticlePath, $wgVaryOnXFP, $wgVerifyMimeType, $wgVersion, $wgVirtualRestConfig,
	   $wgWANObjectCaches, $wgWantedPagesThreshold, $wgWatchersMaxAge, $wgWhitelistRead,
	   $wgWhitelistReadRegexp, $wgWikiDiff2MovedParagraphDetectionCutoff, $wgXMLMimeTypes,
	   $wgXhtmlDefaultNamespace, $wgXhtmlNamespaces, $wgXmlDumpSchemaVersion;
